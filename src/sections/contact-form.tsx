    ...
    <div id='contact' className='w-full bg-[#F0F6FF] py-[60px] lg:py-[120px]'>
      <div className='mx-[10px] max-w-[1280px] xl:mx-auto'>
        <div className='flex flex-col space-y-2 lg:space-y-4'>
          ...
          <h1 className='text-[36px] font-[700] leading-[44px] text-[#02050B] lg:text-[48px] lg:leading-[56px]'>
        ...
        <div className='mt-6 w-full rounded-2xl bg-white p-5 md:mt-12 md:p-8'>
          ...
          >
            <div className='mb-4 grid grid-cols-1 gap-8 md:grid-cols-2'>
              <div>
                ...
                <input
                  type='text'
                  name='name'
                  className='focus:ring-blue-300 block h-12 w-full rounded border-[1px] border-[#D9D9D9] bg-[#f0f6ff] p-3 outline-0 focus:ring-2 md:h-16'
                  id='quote-name'
                  required
                />
              </div>
            ...
            <div className='mb-6'>
              ...
              <textarea
                name='message'
                className='focus:ring-blue-300 block h-48 w-full rounded border-[1px] border-[#D9D9D9] bg-[#f0f6ff] p-3 outline-0 focus:ring-2 md:h-[220px]'
                id='quote-message'
                required
              />
            </div>
