      ...
      <div className='mx-[10px] max-w-7xl xl:mx-auto'>
        <div className='flex flex-col items-center gap-[56px] lg:flex-row'>
          <div className='flex flex-1 flex-col items-center lg:items-start'>
            ...
            <h1 className='mt-4 max-w-3xl text-center text-[40px] font-[700] leading-[50px] md:text-[50px] md:leading-[70px] lg:text-start xl:text-[60px] xl:leading-[85px]'>
              {heroSection?.heading ?? 'Tree Cutting Service Services in New york'}
            </h1>
            <span className='mt-4 text-center text-[20px] leading-[30px] text-black/70 md:text-start lg:mt-6 lg:text-[32px] lg:leading-[44px]'>
